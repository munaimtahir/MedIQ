...
def check_degeneracy(p_L0: float, p_T: float, p_S: float, p_G: float, min_learning_gain: float = 0.05) -> Tuple[bool, str]:
    """
    ...
    if performance_gap < 0.1:
        return False, f"Performance gap too small: (1-S)-G={performance_gap:.3f} < 0.1 (indistinguishable states)"
