...
async def get_active_algo_version(db: AsyncSession, algo_key: str) -> AlgoVersion | None:
    """
...
async def get_active_params(db: AsyncSession, algo_version_id: UUID) -> AlgoParams | None:
    """
...
async def activate_params(db: AsyncSession, params_id: UUID) -> AlgoParams | None:
    """
