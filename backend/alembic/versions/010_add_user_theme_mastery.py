...
def upgrade() -> None:
    ...
    op.create_index('ix_user_theme_mastery_user_id_mastery_score', 'user_theme_mastery', ['user_id', 'mastery_score'])
    op.create_index('ix_user_theme_mastery_user_id_computed_at', 'user_theme_mastery', ['user_id', 'computed_at'])
    op.create_index('ix_user_theme_mastery_theme_id_mastery_score', 'user_theme_mastery', ['theme_id', 'mastery_score'])
    op.create_index('ix_user_theme_mastery_algo_version_id', 'user_theme_mastery', ['algo_version_id'])
