...
down_revision: Union[str, None] = '012_difficulty_adaptive'
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['session_id'], ['test_sessions.id'], onupdate='CASCADE', ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['question_id'], ['questions.id'], onupdate='CASCADE', ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['block_id'], ['blocks.id'], onupdate='CASCADE', ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['theme_id'], ['themes.id'], onupdate='CASCADE', ondelete='SET NULL'),
