...
class TestSpacing:
    ...
    def test_never_attempted_due_now(self):
        ...
        due_date, is_due_now = compute_spacing_days(
            "weak", None, spacing_days, current_date
        )
...
class TestRevisionQueueGeneration:
    ...
    async def test_generate_for_user_with_mastery(self, db, student_user, block_and_themes, revision_algo_version):
    ...
    async def test_weak_theme_due_today(self, db, student_user, block_and_themes, revision_algo_version):
    ...
    async def test_strong_theme_not_due_yet(self, db, student_user, block_and_themes, revision_algo_version):
    ...
    async def test_idempotent_generation(self, db, student_user, block_and_themes, revision_algo_version):
    ...
    async def test_status_protection(self, db, student_user, block_and_themes, revision_algo_version):
...
class TestAlgoRunLogging:
    ...
    async def test_run_logging_on_success(self, db, student_user, block_and_themes, revision_algo_version):
